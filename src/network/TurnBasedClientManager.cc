...
bool m2::network::TurnBasedClientManager::set_ready_token(uint64_t ready_token) {
...
bool m2::network::TurnBasedClientManager::has_incoming_data(bool is_socket_readable) {
...
m2::network::TcpSocketManager& m2::network::TurnBasedClientManager::socket_manager() {
	return std::visit(m2::overloaded{
