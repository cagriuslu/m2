...
void m2::Graphic::DrawCross(const VecF& worldPosition, const float radius, const RGBA& color) {
	DrawLine(worldPosition + VecF{-radius, -radius}, worldPosition + VecF{radius, radius}, color);
	DrawLine(worldPosition + VecF{-radius, radius}, worldPosition + VecF{radius, -radius}, color);
}
