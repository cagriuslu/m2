...
m2::component::Physique::Physique(ID object_id) : Component(object_id), body(nullptr) {}

m2::component::Physique::Physique(Physique&& other) noexcept : Component(other.object_id), body(other.body), on_collision(std::move(other.on_collision)) {
    other.body = nullptr;
}
