...
namespace {
	...
	void CircleSetPixelOnFirstHalf(m2::thirdparty::video::Surface& dstSurface, const m2::RectI& dstRect, const int radius, const int x, const int y) {
	...
	void DiskSetPixelOnFirstHalf(m2::thirdparty::video::Surface& dstSurface, const m2::RectI& dstRect, const int radius, const int x, const int y) {
