...
int Object_InitFromCfg_Player(Object *obj, const CfgObjectTexture *cfg, Vec2F position) {
	// TODO
	return 0;
}

static int (*Object_InitFromCfg_FunctionTable[])(Object *obj, const CfgObjectTexture *cfg, Vec2F position) = {
	NULL,
