...
extern const CfgUIElement LAUNCHER_CFG_UI_ENTRYPOINT_ELEMENT_ARPGBUTTON;
extern const CfgUIElement LAUNCHER_CFG_UI_ENTRYPOINT_ELEMENT_QUITBUTTON;
...
const CfgUIElement LAUNCHER_CFG_UI_ENTRYPOINT_ELEMENT_ARPGBUTTON = {
		.x = 45, .y = 35, .w = 10, .h = 10,
		.borderWidth_px = 1,
...
const CfgUIElement LAUNCHER_CFG_UI_ENTRYPOINT_ELEMENT_QUITBUTTON = {
		.x = 45, .y = 55, .w = 10, .h = 10,
		.borderWidth_px = 1,
