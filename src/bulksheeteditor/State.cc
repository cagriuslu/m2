...
bulksheeteditor::State::~State() { M2_LEVEL.DisablePrimarySelection(); }

pb::SpriteSheets bulksheeteditor::State::ReadSpriteSheetsFromFile() const {
	return *pb::json_file_to_message<pb::SpriteSheets>(_sprite_sheets_path);
}

std::optional<pb::SpriteSheet> bulksheeteditor::State::SelectResource(const std::string& resource) {
...
void bulksheeteditor::State::LookUpAndStoreSpriteRect(std::optional<m2g::pb::SpriteType> sprite) {
	if (sprite) {
...
void bulksheeteditor::State::SetRect(const m2g::pb::SpriteType sprite, const RectI& rect) {
	sheeteditor::modify_sprite_in_sheet(_sprite_sheets_path, sprite, [&](pb::Sprite& sprite_) {
...
void bulksheeteditor::State::Reset(const m2g::pb::SpriteType sprite) {
	sheeteditor::modify_sprite_in_sheet(_sprite_sheets_path, sprite, [&](pb::Sprite& sprite_) {
