...
int32_t m2::HashI(const int8_t value, const int32_t initialValue) {
    return HashI(static_cast<int32_t>(value), initialValue);
}
int32_t m2::HashI(const uint8_t value, const int32_t initialValue) {
    return HashI(static_cast<int32_t>(value), initialValue);
}
int32_t m2::HashI(const int16_t value, const int32_t initialValue) {
    return HashI(static_cast<int32_t>(value), initialValue);
}
int32_t m2::HashI(const uint16_t value, const int32_t initialValue) {
    return HashI(static_cast<int32_t>(value), initialValue);
}
...
int32_t m2::HashI(const float value, const int32_t initialValue) {
    return HashI(*reinterpret_cast<const int32_t*>(&value), initialValue);
}
