...
namespace m2 {
	...
	public:
		...
		bool IsLockstepServer() const { return std::holds_alternative<multiplayer::lockstep::ServerComponents>(_multiPlayerComponents); }
		...
		[[nodiscard]] VecF MousePositionLpx() const { return events.MousePositionLpx(); }
