...
namespace m2 {
	...
	class Sprite final {
		...
		std::vector<pb::SpriteEffectType> _default_variant_draw_order;
	   ...
	   public:
		Sprite() = default;
		Sprite(const std::vector<SpriteSheet>& sprite_sheets, const SpriteSheet& sprite_sheet,
		...
		[[nodiscard]] const std::vector<pb::SpriteEffectType> default_variant_draw_order() const { return _default_variant_draw_order; }
