...
namespace m2::third_party::physics {
	...
	enum ColliderLayer : uint16_t {
		...
		COLLIDER_LAYER_FOREGROUND_FRIENDLY_CARD = 0x0400,
	};
	...
	enum class ColliderCategory {
		...
		COLLIDER_CATEGORY_FOREGROUND_FRIENDLY_CARD,
    ...
    constexpr std::array gColliderCategoryToParams = {
		...
		ColliderParams{
			...
			.collidesWith = COLLIDER_LAYER_FOREGROUND_OBSTACLE
					...
					| COLLIDER_LAYER_FOREGROUND_FRIENDLY_CARD
		},
		...
		// COLLIDER_CATEGORY_FOREGROUND_FRIENDLY_CARD
		ColliderParams{
			.belongsTo = COLLIDER_LAYER_FOREGROUND_FRIENDLY_CARD,
			.collidesWith = COLLIDER_LAYER_FOREGROUND_OBSTACLE
