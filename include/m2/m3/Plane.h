...
namespace m3 {
	struct Plane {
		...
		Plane() = default;
		Plane(const VecF& normal, const VecF& point) : normal(normal), point(point) {}
		static Plane xy_plane(float z_component = 0.0f) { return {VecF{0.0f, 0.0f, 1.0f}, VecF{0.0f, 0.0f, z_component}}; }
