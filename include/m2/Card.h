...
namespace m2 {
	class Card {
		pb::Card _card;
		std::vector<VariableValue> _constants = std::vector<VariableValue>(pb::enum_value_count<m2g::pb::ConstantType>());
	...
	public:
		...
		[[nodiscard]] VariableValue GetConstant(const m2g::pb::ConstantType c) const { return _constants[pb::enum_index(c)]; }
