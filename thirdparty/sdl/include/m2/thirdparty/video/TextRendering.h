...
namespace m2::thirdparty::video {
	...
	int CalculateMaxRenderedUtf8Length(Font& font, int fontSize, const char* utf8Text, int widthInPixels);
	...
	VecI CalculateRenderedUtf8Size(Font& font, int fontSize, const char* utf8Text);
}
