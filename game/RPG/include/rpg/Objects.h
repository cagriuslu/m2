...
namespace rpg {
	...
	m2::void_expected create_blade(m2::Object& obj, const m2::VecF& position, const m2::VecF& direction, const m2::Item& melee_weapon, bool is_friend);
	...
	m2::void_expected create_dropped_item(m2::Object& obj, const m2::VecF& position, m2g::pb::ItemType item_type);

	m2::void_expected init_finish_point(m2::Object& obj, const m2::VecF& position);

	m2::void_expected create_projectile(m2::Object& obj, const m2::VecF& position, const m2::VecF& intended_direction, const m2::Item& ranged_weapon, bool is_friend);
