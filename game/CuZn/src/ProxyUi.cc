...
static TextInputBlueprint id_addr = {.initial_text = "127.0.0.1"};
static TextBlueprint connect_button = {.initial_text = "CONNECT", .on_action = [](MAYBE const widget::Text& self) {
...
static const Blueprint ip_port_form = {
    ...
    .background_color = {20, 20, 20, 255},
    .widgets = {
        WidgetBlueprint{.x = 55, .y = 30, .w = 10, .h = 10, .border_width_px = 0, .variant = ip_label},
        WidgetBlueprint{
...
static const Blueprint server_lobby = {
    ...
    .widgets = {
        ...
        WidgetBlueprint{
            .x = 80, .y = 40, .w = 40, .h = 10, .border_width_px = 1, .padding_width_px = 5, .variant = client_count},
    }};

static TextBlueprint join_button = {.initial_text = "JOIN", .on_action = [](MAYBE const widget::Text& self) {
	                                    return m2::ui::State::create_execute_sync(&ip_port_form);
                                    }};
static TextBlueprint host_button = {.initial_text = "HOST", .on_action = [](MAYBE const widget::Text& self) {
...
const Blueprint main_menu_blueprint = {
    ...
    .widgets = {
        WidgetBlueprint{
            .x = 70, .y = 20, .w = 20, .h = 10, .border_width_px = 1, .padding_width_px = 5, .variant = join_button},
        WidgetBlueprint{
            .x = 70, .y = 40, .w = 20, .h = 10, .border_width_px = 1, .padding_width_px = 5, .variant = host_button},
        WidgetBlueprint{
            .x = 70, .y = 60, .w = 20, .h = 10, .border_width_px = 1, .padding_width_px = 5, .variant = quit_button}}};

static TextBlueprint resume_button = {.initial_text = "RESUME", .on_action = [](MAYBE const widget::Text& self) {
	                                      return make_return_action<m2::Void>();  // TODO Return value
                                      }};
...
const Blueprint pause_menu_blueprint = {
    ...
    .widgets = {
        WidgetBlueprint{
            .x = 45, .y = 35, .w = 10, .h = 10, .border_width_px = 1, .padding_width_px = 5, .variant = resume_button},
        WidgetBlueprint{
            .x = 45,
            .y = 55,
            .w = 10,
