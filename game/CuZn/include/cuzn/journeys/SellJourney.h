...
protected:
	...
	std::optional<SellJourneyStep> handle_industry_location_poi_signal(POI poi);
	std::optional<SellJourneyStep> handle_industry_location_cancel_signal();
	...
	std::optional<SellJourneyStep> handle_merchant_location_poi_signal(POI poi);
	...
	std::optional<SellJourneyStep> handle_resource_poi_signal(POI poi);
