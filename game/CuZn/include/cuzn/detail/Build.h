...
namespace cuzn {
	...
	/// Validates whether player can build the given infrastructure in the given location using the given card.
	/// Returns the next buildable tile type from player's inventory.
	/// Coal and iron requirements of the tile is not validated.
	m2::expected<m2g::pb::ItemType> can_player_build_infrastructure(m2::Character& player, m2g::pb::ItemType card, m2g::pb::SpriteType location);
}
