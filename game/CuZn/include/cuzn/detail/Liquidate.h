...
int IsLiquidationNecessaryForPlayer(m2::FastCharacter& player);
...
m2::expected<std::pair<std::vector<m2::Object*>, int>> CanPlayerLiquidateFactories(m2::FastCharacter& player, const m2g::pb::TurnBasedClientCommand_LiquidateAction&);
